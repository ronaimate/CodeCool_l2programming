...
public class FragmentEnglishCover extends Fragment {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_english_cover, container, false);
        getActivity().setTitle("English Test");

        TextView button = (TextView) view.findViewById(R.id.fragment_english_action_button);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent surveyIntent = new Intent(getActivity(), SurveyActivity.class);
                surveyIntent.putExtra("testType", TestType.ENGLISH.toString());
